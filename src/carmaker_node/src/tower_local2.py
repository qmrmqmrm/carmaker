...
def main():
	...
	while 1:
		...
		try:
			(trans, rot) = listener.lookupTransform('localization', 'Wheel_Rear', rospy.Time(0))
			print(trans)
			print(rot)
		...
		try:
			...
			last_index = len(cx) - 1
			target_ind, Ld, now_ind, test_mode, test_ind_1, test_ind_2 = target_course.search_target_index(state, Lf_k)
		...
		if last_index > target_ind:
			...
			delta_gain, tx, ty, alpha, delta_rad, delta, alpha_m, delta_m_rad, delta_m, Ld_m, car_alpha_m, car_pr, car_fr, pu_ind, pu_pind = pure_pursuit_steer_control(state, target_course, target_ind, Ks)
			...
			print("localization2 x : ", controller.car_local_2_point_x, "localization2 y : ", controller.car_local_2_point_y)
			...
			print("lo_2 dx : ", controller.car_local_2_point_x - tx, "lo_2 dy : ", controller.car_local_2_point_y - ty)
			...
			dlo_2 = np.hypot(tx - controller.car_local_2_point_x, ty - controller.car_local_2_point_y)
			dlo_2_0 = np.hypot(tx_tar - controller.car_local_2_point_x, ty_tar - controller.car_local_2_point_y)
			dlo_2_1 = np.hypot(tx_tar_1 - controller.car_local_2_point_x, ty_tar_1 - controller.car_local_2_point_y)
			dlo_2_2 = np.hypot(tx_tar_2 - controller.car_local_2_point_x, ty_tar_2 - controller.car_local_2_point_y)
			dlo_2_3 = np.hypot(tx_tar_3 - controller.car_local_2_point_x, ty_tar_3 - controller.car_local_2_point_y)
			dlo_2_now = np.hypot(tx_now - controller.car_local_2_point_x, ty_now - controller.car_local_2_point_y)
